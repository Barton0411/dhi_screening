...
- 当前发布版本：`v4.02.31`
- 发布内容：基于 v4.02.30 的更新器生命周期修复发布验证版本，用于实际验证 v4.02.30 → v4.02.31 自动强制更新；同时包含默认伊起牛登录、系统凭据库记住密码、主界面检查更新、显示设置和高 DPI 修复。
...
- 代码与 v4.02.30 的更新器修复保持一致，仅升级发布版本和强制更新说明。
- 用于从已安装的 v4.02.30 实测更新提示、下载安装和启动安装包的完整链路。
